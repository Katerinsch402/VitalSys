...
<div class="card card-main">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex">
            <form action="<?php echo e(route('especialidades.index')); ?>" method="GET" class="mr-2">
        ...
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><i class="fas fa-stethoscope mr-1" style="color:#17a2b8;"></i> <?php echo e($e->nombre); ?></td>
                        <td>
                            <button class="btn btn-sm btn-info mr-1" data-toggle="modal" data-target="#verEspecialidadModal<?php echo e($e->id_especialidad); ?>">
                                <i class="fas fa-eye"></i>
                            </button>
                            <button class="btn btn-sm btn-warning mr-1" data-toggle="modal" data-target="#editarEspecialidadModal<?php echo e($e->id_especialidad); ?>">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form action="<?php echo e(route('especialidades.destroy', $e->id_especialidad)); ?>" method="POST" style="display:inline-block;">
                                <?php echo csrf_field(); ?>
                    ...
                    <!-- Modal Ver -->
                    <div class="modal fade" id="verEspecialidadModal<?php echo e($e->id_especialidad); ?>" tabindex="-1" data-backdrop="static" aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-4">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo e($e->nombre); ?>" disabled>
                    ...
                    <!-- Modal Editar -->
                    <div class="modal fade" id="editarEspecialidadModal<?php echo e($e->id_especialidad); ?>" tabindex="-1" data-backdrop="static" aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header modal-header-custom">
                                ...
                                <div class="modal-body p-4">
                                    <form action="<?php echo e(route('especialidades.update', $e)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <label class="form-label">Nombre</label>
                                        <input type="text" class="form-control mb-3" name="nombre" value="<?php echo e($e->nombre); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\TFG\VitalSys-main\resources\views/especialidades/index.blade.php ENDPATH**/ ?>