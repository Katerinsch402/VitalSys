...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Permisos para vista de tipos de enfermedad
        $permTipoEnfermedad1 = Permission::create(['name' => 'ver tipo_enfermedad']);
        $permTipoEnfermedad2 = Permission::create(['name' => 'crear tipo_enfermedad']);
        $permTipoEnfermedad3 = Permission::create(['name' => 'modificar tipo_enfermedad']);
        $permTipoEnfermedad4 = Permission::create(['name' => 'borrar tipo_enfermedad']);
