...
@section('content_header')
    <div class="d-flex align-items-center">
        ...
        <h1 class="font-weight-bold mb-0">Registrar Sala</h1>
    </div>
@stop
    ...
    <div class="col-md-6">
        <div class="card card-form">
            <div class="card-header">
                <i class="fas fa-plus-circle mr-2"></i> Nueva Sala
            </div>
            <div class="card-body p-4">
                <form method="POST" action="{{ route('salas.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('tipo_sala') is-invalid @enderror" name="tipo_sala" value="{{ old('tipo_sala') }}" placeholder="Ej: Consulta General" required>
                        @error('tipo_sala')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('num_sala') is-invalid @enderror" name="num_sala" value="{{ old('num_sala') }}" placeholder="Ej: 101" required>
                        @error('num_sala')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn text-white" style="background:linear-gradient(135deg,#17a2b8,#138496);border:none;border-radius:8px;">
                            <i class="fas fa-save mr-1"></i> Registrar Sala
                        </button>
                    </div>
                </form>
            </div>
