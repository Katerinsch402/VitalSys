<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-input-error :messages="$errors->updatePassword->get('curren
            t_password')" class="mt-2" />
        </div>

        <div>
            <x-input-label style="color: #111827;" for="password" :value="__('Nueva Contraseña')" />
            <x-text-input style="background-color: white; color: #111827;" id="password" name="password" type="password" class="mt-1 block w-full" autocomplete="new-password" />
